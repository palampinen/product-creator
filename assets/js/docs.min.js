...
function parseTimestamps(mydate) {
	...
	tmp1 = new Date( parts[2],parts[1],parts[0],0,0,0);
	tmp2 = new Date( parts[2],parts[1],parts[0],23,59,59 );
	
	return [tmp1.getTime(),tmp2.getTime()];
